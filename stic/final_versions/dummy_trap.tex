...
% Admiral Akbar
\node[inner sep=0pt] (russell) at (-0.3,-0.8) {\includegraphics[angle=0,scale=0.2]{old_trap.png}};    
...
% Radius of regular polygons
 ...
 \draw (0:\R)
     \foreach \x in {60,120,...,360} {  -- (\x:\R) }
              ...
              -- cycle (120:\R)
              -- cycle (60:\R)
              -- cycle (0:\R)  [line width=3.8pt,color=black];
\end{scope}       
       
% Matrix              
\draw[color=black,draw,align=left] (-0.97,0.8) node[right] { \footnotesize{ $\displaystyle
 \begin{pmatrix}
