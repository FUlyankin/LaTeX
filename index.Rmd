...
Будем охотиться за зайцами и убивать одним ударом сразу 70! За пару мы решим одну практическую задачу в связке R+LaTeX и получим для размышлений вторую. Вторую мы решим вместе на последнем семинаре. Будет ~~сложно~~ интересно! 
...
* [Texовский файл]( ) с презентацией
* [Архив]( ) с презентацией
