...
### Занятие 8 (вроде бы 6 апреля)
Это будет последнее занятие по LaTeX. На нём мы обсудим решение последних домашек, обсудим как добавлять в LaTeX формулы из Wolfram, поговорим о Markdown, Git и ультрановомодном редакторе всего Atom. А после мы разбежимся до Python. 
...
* [Архив](https://github.com/FUlyankin/LaTeX/raw/master/sem_7/longpfd.zip) много похожих pdf-файлов
...
#### Презентации:
* **Утром 23 марта файл с презентацией будет обновлён**
