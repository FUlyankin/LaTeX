...
Метод наименьших квадратов (OLS) & \begin{center}
 ...
 \begin{minipage}[c]{0.49\linewidth} \center{\includegraphics[width=\linewidth]{gauss.jpg}\\}
\end{minipage} \hfill \begin{minipage}[c]{0.49\linewidth} \center{\includegraphics[width=\linewidth]{lezhandr.jpg}\\}
\end{minipage}
%{\includegraphics[width=0.49\linewidth]{gauss.jpg}\includegraphics[width=0.49\linewidth]{lezhandr.jpg}}  
