...
%\setbeamercolor{frametitle}{bg=backgr}
...
\begin{enumerate}
   ...
   \item  \textbf<3>{\alert<4-4>{This line is bold only on the third slide.}}
...
\begin{itemize}
	...
	\item[1+1] Презентация должна содержать таблицы и картинки 
