...
# Запоминаем носочки по аналогии с шапочкой :)
fileName <- "socks.Rnw"
...
people <- 1:length(df$V1)   # Будем делать проход по всем людям. От Никиты до Саши. 
...
ankets <- paste0("Anketa_",1:length(df$V1),".Rnw")
