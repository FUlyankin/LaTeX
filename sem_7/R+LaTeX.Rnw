...
# include (TRUE) Если изменить на FALSE - то в документе не будет показан этот кусок кода. 
...
@
\caption{Гистограмка для стоимости акций ггул! \label{fig}}
\end{figure}
...
Чанкам можно давать имена. И использовать эти имена в других кусках кода. Например, сделаем два чанка и не будем их выводить.
...
Следующий чанк использует в себе информацию из чанков Вениамин и Антон :)
