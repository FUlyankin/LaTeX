...
\item Хорошая идея - установить на комп шрифтовый менеджер для безболезненной установки шрифтов
\item Хороший \href{https://apps.ubuntu.com/cat/applications/precise/font-manager/}{ шрифтовый менеджер} для Linux 
\item Хороший \href{http://www.proximasoftware.com/fontexpert/}{ шрифтовый менеджер} для Windows 
\end{itemize}
\end{frame}
}


% Вставить сюда инструкцию по установке шрифтового менеджера! 
% Установить шрифт воров или ещё какой-нибудь! 
...
% закоментить команду для отступов и показать что будет 
