...
\hfill
\begin{minipage}[h]{0.3\linewidth}
\center{\includegraphics[width=1\linewidth]{pop3.pdf}}
\end{minipage}
\vfill
\begin{minipage}[h]{0.3\linewidth}
\hspace*{-2.6cm}{\includegraphics[angle=45,width=2.3\linewidth]{pop4.pdf}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.3\linewidth}
\center{\includegraphics[width=1\linewidth]{pop8.pdf}}
\end{minipage}
\hfill
\begin{minipage}[h]{0.3\linewidth}
{\includegraphics[angle=180,width=1\linewidth]{pop10.pdf}}
\end{minipage}
\end{figure}
