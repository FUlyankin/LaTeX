...
% Использовать p,m,b --- не очень хорошая идея...
...
\section{Когда лень прописывать все столбцы}
...
% Обратите внимание! В таблице стоят разделители. Но милый booktabs бьёт нас за них по рукам и отнимает их у нас. 
