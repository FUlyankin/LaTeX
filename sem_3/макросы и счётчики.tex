...
% Можно придумывать для окружений необязательные аргументы!
\newenvironment{argument}[1][]{%
\par
\noindent
\textbf{Аргумент в споре #1:}
\noindent}
{}
...
\begin{argument}[с Машей]
Она не очень умная!
\end{argument}

% Свои окружения, как и команды лучше всего прописывать в преамбуле! 
