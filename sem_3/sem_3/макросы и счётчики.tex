...
%\noindent \ignorespaces \color{green} \fontsize{15}{1.2ex}\selectfont
...
\subsection{Проверяем наличие аргумента} 

\NewDocumentCommand{\alice}{ m g }
 {%
  \IfNoValueTF{#2}%
   {%
    \it \noindent\ignorespaces #1 \\[5pt]
   \rightline{{Кто-то (Льюис Кэррол) }}
   }
   {
    \it \noindent\ignorespaces #1 \\[5pt]
